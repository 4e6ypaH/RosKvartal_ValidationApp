...
namespace ValidationApp.Validators
{
    public class MyValidationProvider : ModelValidatorProvider
    {
        public override IEnumerable<ModelValidator> GetValidators(ModelMetadata metadata, ControllerContext context)
        {
            ...
            {
                return new ModelValidator[] { new BookPropertyValidtor(metadata, context) };
            }
    ...
    public class BookPropertyValidtor : ModelValidator
    {
        public BookPropertyValidtor(ModelMetadata metadata, ControllerContext controllerContext)
